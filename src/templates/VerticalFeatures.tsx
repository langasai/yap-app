...
const VerticalFeatures = () => (
  ...
  >
    ...
    <VerticalFeatureRow
      ...
      description="Don't just learn to translate to your mother tongue like the other language apps make you do. Embrace your different self as you speak a different inner language."
